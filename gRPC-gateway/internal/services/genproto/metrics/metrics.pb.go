...
const file_metrics_proto_rawDesc = "" +
	...
	"\x05cores\x18\x03 \x03(\v2\x11.logboy.CoreUsageR\x05cores\"n\n" +
	"\aMetrics\x125\n" +
	"\vmemoryUsage\x18\x01 \x01(\v2\x13.logboy.MemoryUsageR\vmemoryUsage\x12,\n" +
	"\bcpuUsage\x18\x02 \x01(\v2\x10.logboy.CpuUsageR\bcpuUsage\"\x1c\n" +
	"\bResponse\x12\x10\n" +
	"\x03ack\x18\x01 \x01(\bR\x03ack2G\n" +
	"\x0eMetricsService\x125\n" +
	"\x0eReceiveMetrics\x12\x0f.logboy.Metrics\x1a\x10.logboy.Response(\x01B\x17Z\x15gRPC-gateway/protogenb\x06proto3"
...
var file_metrics_proto_goTypes = []any{
	...
	(*Response)(nil),    // 4: logboy.Response
}
var file_metrics_proto_depIdxs = []int32{
	...
	4, // 4: logboy.MetricsService.ReceiveMetrics:output_type -> logboy.Response
